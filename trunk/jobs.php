...
?>
	...
	<div id='col2'>
        ...
        <p>The role is to do research and to write articles about traveling information to Vietnam for the website in English. We do not require much from applicants. If you feel you have these following abilities and characteristics, please send your CV (in English) to vietnamwiki@googlemail.com:</p>
        <ul>
        <li><strong>Mandatory</strong>: Very good at writing and reading English.</li>
        <li>Loving traveling, loving Vietnam, general knowledge of internet and enjoying working with a laptop and internet are advantages.</li>
	    ...
	    <p>The role is to develop the website using PHP, MySQL, Javascript and JQuery. We do not require much from applicants. If you feel you have these following abilities and characteristics, please send your CV (in English) to vietnamwiki@googlemail.com:</p>
	    <ul>
	    <li><strong>Mandatory</strong>: at least 1 year experience with PHP or Javascript (this could be self-taught experience).</li>
