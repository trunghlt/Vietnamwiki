...
<div id="fbDiv">
	...
	<a id="fbButton" onClick="jQuery('#fbContent').toggle(300); jQuery('#slideButtonLeft').toggle();jQuery('#slideButtonLeftActive').toggle();">
		<div id="slideButtonLeft" style="background: url(/images/vnwkImageMap.gif) -360px 0px no-repeat; width: 26px; height: 125px;"></div>
		<div id="slideButtonLeftActive" style="background: url(/images/vnwkImageMap.gif) -360px -130px no-repeat; width: 26px; height: 125px; display: none;"></div>
	</a>
</div>
