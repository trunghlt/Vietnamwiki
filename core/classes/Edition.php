...
class Edition {
	...
	//edit
	public function edit($id,$edition,$post_id,$post_sub,$post_sum,$smal_img,$big_url){
		...
		if(is_array($row))
		{
				...
				{	
					mysql_query(" INSERT INTO posts_texts
								...
								VALUE ('".$post_sub."','".$post_sum."','".$mysql['postContent']."','".$smal_img."','".$big_url."') ");
					...
					mysql_query("UPDATE editions
						SET post_text = '".$mysql["postContent"]."', post_id = '".$r['post_id']."'
						WHERE id = ".$id) or die(mysql_error());
				}	
		}
	}
